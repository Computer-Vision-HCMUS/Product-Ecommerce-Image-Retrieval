...
if __name__ == '__main__':
    ...
    gallery_image_prefix="/images"

    gallery_unit_id_label=io_process.read_json("/multi_modal/data/product5m_v2/subset_v3_train_id_label.json")
    gallery_unit_id_list=list(io_process.read_json("/multi_modal/data/product5m_v2/subset_v3_train_id_label.json").keys())[start*10000:end*10000]

    extract_feat(gallery_unit_id_list,gallery_image_prefix,"/multi_modal/data/tsv_features/subset_v3_train_{}w_{}w.tsv".format(args.start,args.end),predictor,gallery_unit_id_label)
