...
\clearpage
\section*{Appendix: Frontend interface}

Phu luc nay minh hoa giao dien cua he thong retrieval trong ba trang thai su dung chinh.

\begin{figure}[p]
    \centering
    \includegraphics[width=0.82\textwidth]{figure/fe1.jpg}
    \caption{Giao dien nhap truy van raw voi Text va PV attributes.}
    \label{fig:frontend-raw-query}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.82\textwidth]{figure/fe2.jpg}
    \caption{Giao dien tim kiem theo Catalog ID va danh sach ket qua Top-$K$.}
    \label{fig:frontend-catalog-id}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.82\textwidth]{figure/fe3.jpg}
    \caption{Trang chi tiet mot san pham duoc mo tu ket qua retrieval.}
    \label{fig:frontend-product-detail}
\end{figure}
